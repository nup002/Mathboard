...
Reset button for at least half a second, then release it. The Reset button is located here:

<img src="_media/bottom_labelled.svg" style="width: 100%; max-width: 500px;">

### Step 3: Drag and drop the firmware file
When you release the Reset button, a folder named `RPI-RP2` will appear on your computer. If it does not appear 
