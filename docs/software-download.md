...
Mathpad Service has been developed by Summa Cogni. For more information and older releases, see the 
[Mathpad release page](https://github.com/Summa-Cogni/Mathpad/tags).

## WinCompose
[WinCompose](https://github.com/samhocevar/wincompose/releases/download/v0.9.11/WinCompose-Setup-0.9.11.exe) is a small tray 
application for Windows that enables Unicode compose functionality. It is not developed by Summa Cogni.

For more information and older releases, see [https://wincompose.info](https://wincompose.info).
