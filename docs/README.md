...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between; text-align: center; margin: 10px 0;">
  ...
  <div style="flex: 1; padding: 10px; min-width: 250px; max-width: 400px;">
    ...
    <h3><a href="#/get_started.md" style="text-decoration: none;">Learn the ropes</a></h3>
    <p>Start using your Mathpad right now by following the interactive 
    <a href="#/get_started.md" style="text-decoration: none;">Getting Started guide</a>. </p>
  </div>
