...
void send_unicode_on_keypress(int symbol, keyrecord_t *record);
 ...
 #define _notequal 0x2260              // https://www.compart.com/en/unicode/U+2260 (not equal to)
 #define _almostequal 0x2248           // https://www.compart.com/en/unicode/U+2248 (almost equal to)
 #define _proportional 0x221D          // https://www.compart.com/en/unicode/U+221D (proportional to)
 #define _identicalto 0x2261           // https://www.compart.com/en/unicode/U+2261 (identical to)
 #define _lessorequal 0x2264           // https://www.compart.com/en/unicode/U+2264 (less than or equal to)
 #define _greaterorequal 0x2265        // https://www.compart.com/en/unicode/U+2265 (greater than or equal to)
 #define _much_greater_than 0x226B     // https://www.compart.com/en/unicode/U+226B (much greater than)
 #define _verymuch_greater_than 0x22D9 // https://www.compart.com/en/unicode/U+22D9 (very much greater than)
 #define _much_less_than 0x226A        // https://www.compart.com/en/unicode/U+226A (much less than)
 #define _verymuch_less_than 0x22D8    // https://www.compart.com/en/unicode/U+22D8 (very much less than)
 ...
 #define _prime 0x2032                 // https://www.compart.com/en/unicode/U+2032 (prime - not in use currently)
 #define _double_prime 0x2033          // https://www.compart.com/en/unicode/U+2033 (double prime - not in use currently)
 #define _triple_prime 0x2034          // https://www.compart.com/en/unicode/U+2034 (triple prime - not in use currently)
 #define _quadruple_prime 0x2057       // https://www.compart.com/en/unicode/U+2057 (quadruple prime - not in use currently)
