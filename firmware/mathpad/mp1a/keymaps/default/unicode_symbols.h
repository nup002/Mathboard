...
void send_unicode_on_keypress(int symbol, keyrecord_t *record);
 ...
 #define _combining_2dot 0x0308        // https://www.compart.com/en/unicode/U+0308 (combining double dot above )
 #define _combining_3dot 0x20DB        // https://www.compart.com/en/unicode/U+20DB (combining triple ddot above ◌⃛)
