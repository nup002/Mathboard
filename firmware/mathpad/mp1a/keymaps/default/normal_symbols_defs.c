...
void union_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE){send_unicode_on_keypress(_union, record);}
    else if (user_config.MODE == MOF_MODE){send_mof_on_keypress(UNION_MOF, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(union_LTX, record);}
};

void intersection_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE){send_unicode_on_keypress(_intersection, record);}
    else if (user_config.MODE == MOF_MODE){send_mof_on_keypress(INTERSECTION_MOF, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(intersection_LTX, record);}
};
...
void emptyset_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_empty_set, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(empty_set_LTX, record);}
};
...
void arrow_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_arrow, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(arrow_LTX, record);}
};

void setdifference_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_set_difference, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(set_difference_LTX, record);}
};
...
void partialderivative_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_partial_derivative, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(partial_derivative_LTX, record);}
};
...
void arrowimplies_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_arrow_implies, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(arrow_implies_LTX, record);}
};

void arrowifandonlyif_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_arrow_if_and_only_if, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(arrow_if_and_only_if_LTX, record);}
};
...
void crossproduct_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_times, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(crossproduct_LTX, record);}
};
...
void parallel_key(keyrecord_t *record){
    if (user_config.MODE == UC_MODE || user_config.MODE == MOF_MODE){send_unicode_on_keypress(_parallel, record);}
    else if (user_config.MODE == LTX_MODE){send_latex_on_keypress(parallel_LTX, record);}
};
...
void matrix_key(keyrecord_t *record){
    ...
    else if (user_config.MODE == MOF_MODE){send_mof_on_keypress(MATRIX_MOF, record);}
};
