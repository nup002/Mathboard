...
extern const symbol_definition_t SYMBOL_INTERSECTION;
extern const symbol_definition_t SYMBOL_ELEMENT_OF;
extern const symbol_definition_t SYMBOL_NOT_ELEMENT_OF;
extern const symbol_definition_t SYMBOL_CONTAINS_AS_MEMBER;
